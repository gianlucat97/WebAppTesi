		...
		<h2 x-test-tpl-4>Modifica del prodotto - ${prodottoDaModificare.nome}</h2>
			<div style="margin 20px;" x-test-tpl-5>
				<form method="POST" action="update" id="datiProdotto" x-test-hook-6>
					...
					<div x-test-hook-17>
						<input type="submit" name="inviodatiprodotto" value="Salva modifiche" x-test-hook-18 />
					</div>
		...
		<h2 x-test-tpl-19>Nuovo prodotto</h2>
			<div style="margin 20px;" x-test-tpl-20>
				<form method="POST" action="add" id="datiProdotto" x-test-hook-21>
					...
					<div x-test-hook-31>
						<input type="submit" name="inviodatiprodotto" value="Aggiungi" x-test-hook-32 />
					</div>
			...
			<table x-test-hook-36>
				...
				<tbody x-test-hook-43>
					...
					<tr x-test-hook-44>
						...
						<td x-test-hook-48>
							<a href="delete?id=${prodotto.id}" x-test-hook-49>Cancella</a>
							<a href="prodotti?id=${prodotto.id}" x-test-hook-50>Rettifica</a>
						</td>
					</tr>
					</#list>
				</tbody>
