...
class SuiteCreateAndAssertClienteHooks {
...
private static StringBuffer verificationErrors = new StringBuffer();
  ...
  @Test
  public void testSuiteCreateAndAssertClienteHooks_loc_Hooks_release_2_0() throws Exception {
    ...
    driver.findElement(By.xpath("//*[@x-test-tpl-20]//*[@x-test-hook-24]")).sendKeys("Aurelio");
    ...
    driver.findElement(By.xpath("//*[@x-test-tpl-20]//*[@x-test-hook-30]")).sendKeys("500");
    assertEquals("Aurelio", driver.findElement(By.xpath("//*[@x-test-tpl-20]//*[@x-test-hook-24]")).getAttribute("value"));
	assertEquals("Rossi", driver.findElement(By.xpath("//*[@x-test-tpl-20]//*[@x-test-hook-27]")).getAttribute("value"));
	assertEquals("500", driver.findElement(By.xpath("//*[@x-test-tpl-20]//*[@x-test-hook-30]")).getAttribute("value"));
