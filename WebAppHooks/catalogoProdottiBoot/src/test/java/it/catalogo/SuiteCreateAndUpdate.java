...
public class SuiteCreateAndUpdate {
  ...
  @Test
  public void testSuiteCreateAndUpdate() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Cancella'])[10]/following::a[1]")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Descrizione'])[1]/following::div[1]")).click();
    driver.findElement(By.id("prezzo")).clear();
